...
def crashInfo(*args, crashFile: bool | int = ..., cf: bool | int = ..., crashLog: bool | int = ..., cl: bool | int = ..., query: bool | int = ..., q: bool | int = ..., savedBeforeCrash: bool | int = ..., sbc: bool | int = ...) -> Any: ...
...
def dbtrace(*args, filter: bool | int | _util.ProxyUnicode | str = ..., f: bool | int | _util.ProxyUnicode | str = ..., info: bool | int = ..., i: bool | int = ..., keyword: bool | int | str | List[str] = ..., k: bool | int | str | List[str] = ..., mark: bool | int = ..., m: bool | int = ..., off: bool | int = ..., None: bool | int = ..., output: bool | int | _util.ProxyUnicode | str = ..., o: bool | int | _util.ProxyUnicode | str = ..., query: bool | int = ..., q: bool | int = ..., timed: bool | int = ..., tm: bool | int = ..., title: _util.ProxyUnicode | str = ..., t: _util.ProxyUnicode | str = ..., verbose: bool | int = ..., v: bool | int = ...) -> Any: ...
...
def loadPlugin(*args, addCallback: str | Callable = ..., ac: str | Callable = ..., allPlugins: bool | int = ..., a: bool | int = ..., name: _util.ProxyUnicode | str = ..., n: _util.ProxyUnicode | str = ..., pluginPath: bool | int = ..., pp: bool | int = ..., qObsolete: bool | int = ..., q: bool | int = ..., quiet: bool | int = ..., qt: bool | int = ..., removeCallback: str | Callable = ..., rc: str | Callable = ...): ...
...
def openCLInfo(*args, limitMinimumVerts: bool | int = ..., lmv: bool | int = ..., minVertexBuffer: bool | int | int = ..., mvb: bool | int | int = ..., query: bool | int = ..., q: bool | int = ..., supportsDoublePrecision: bool | int = ..., dbl: bool | int = ..., valid: bool | int = ..., v: bool | int = ...) -> Any: ...
...
def translator(*args, defaultFileRule: bool | int = ..., dfr: bool | int = ..., defaultOptions: bool | int | _util.ProxyUnicode | str = ..., do: bool | int | _util.ProxyUnicode | str = ..., extension: bool | int = ..., ext: bool | int = ..., fileCompression: bool | int | _util.ProxyUnicode | str = ..., cmp: bool | int | _util.ProxyUnicode | str = ..., filter: bool | int = ..., f: bool | int = ..., findTranslator: Tuple[str, int] = ..., ft: Tuple[str, int] = ..., list: bool | int = ..., l: bool | int = ..., loaded: bool | int = ..., ld: bool | int = ..., objectType: bool | int = ..., ot: bool | int = ..., optionsScript: bool | int = ..., os: bool | int = ..., query: bool | int = ..., q: bool | int = ..., readSupport: bool | int = ..., rs: bool | int = ..., writeSupport: bool | int = ..., ws: bool | int = ...) -> Any: ...
