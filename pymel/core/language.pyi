...
def sortStringArray(*args, ignoreCase: bool | int = ..., ic: bool | int = ..., indexArray: bool | int = ..., ia: bool | int = ..., reverse: bool | int = ..., rev: bool | int = ..., sortOrder: _util.ProxyUnicode | str = ..., ord: _util.ProxyUnicode | str = ...) -> Any: ...
